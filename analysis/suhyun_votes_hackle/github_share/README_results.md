...
- `figures/05_votes_attendance_daily.png`
- `figures/06_revisit_hackle_session_day.png`
- `figures/06_votes_payment_daily.png`
- `figures/07_payment_paid_unpaid.png`
- `figures/07_votes_question_daily.png`
- `figures/08_hackle_daily.png`
- `figures/08_payment_product_distribution.png`
- `figures/09_notice_event_distribution.png`
- `figures/09_revisit_votes_attendance.png`
- `figures/10_notice_event_total.png`
- `figures/10_revisit_hackle_session_day.png`
- `figures/11_notice_event_2plus_days.png`
- `figures/11_payment_paid_unpaid.png`
- `figures/12_activity_days_bucket.png`
- `figures/12_payment_product_distribution.png`
...
## Table previews
- `tables/01_votes_출석_일별_표.csv`
- `tables/01_빠른_로드_확인_hackle_선택_event_key_요약.csv`
- `tables/02_votes_결제_일별_표.csv`
- `tables/02_votes_출석_일별_표.csv`
- `tables/03_votes_결제_일별_표.csv`
- `tables/03_votes_질문_기록_일별_표.csv`
- `tables/04_hackle_일별_표.csv`
- `tables/04_votes_질문_기록_일별_표.csv`
- `tables/05_hackle_일별_표.csv`
- `tables/05_votes_출석_재방문_요약.csv`
- `tables/06_hackle_재방문_반복_행동_요약.csv`
- `tables/06_votes_출석_일별_표.csv`
- `tables/07_votes_결제_일별_표.csv`
- `tables/07_결제_KPI_표.csv`
- `tables/08_productId별_결제_분포_표.csv`
- `tables/08_votes_질문_기록_일별_표.csv`
- `tables/09_hackle_일별_표.csv`
- `tables/09_알림_타임라인_event_key_분포_요약.csv`
- `tables/10_votes_출석_재방문_요약.csv`
- `tables/10_알림_타임라인_event_key_전체_건수.csv`
- `tables/11_hackle_재방문_반복_행동_요약.csv`
- `tables/11_알림_타임라인_2일_이상_반복_세션_표.csv`
- `tables/12_결제_KPI_표.csv`
- `tables/12_비연속_누적_활동일_수_구간_요약.csv`
- `tables/13_productId별_결제_분포_표.csv`
- `tables/13_최장_연속_활동일_수_구간_요약.csv`
- `tables/14_질문_기록_역할별_요약.csv`
- `tables/15_hackle_click_question_open_분포_요약.csv`
- `tables/16_친구_요청_구간별_요약.csv`
- `tables/17_친구_요청_분포_요약.csv`
- `tables/18_hackle_초대_공유_요약.csv`
- `tables/19_hackle_초대_공유_session_분포_요약.csv`
